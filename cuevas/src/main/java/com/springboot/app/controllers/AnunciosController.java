...
import com.springboot.app.service.AnunciosService;
...
public class AnunciosController {
	...
	@GetMapping(value="todosAnuncios",produces=MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody List<Anuncios>  listaDeAnuncios(Model model) {
